...
public final class WavClip implements SoundClip, Base
{
  private static final Map<String, WavClip> loadedClips = new HashMap<>();
  ...
  {
    return Assets.class.getResourceAsStream("/rotp/" + n);
  }
}
