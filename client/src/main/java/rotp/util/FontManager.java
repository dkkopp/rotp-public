...
public enum FontManager implements Base
{
  ...
  {
    return getFont(dlgFont, n, dlgSize);
  }

  @Override
  public Font narrowFont(int n)
  {
    return getFont(narrowFont, n, narrowSize);
  }

  @Override
  public Font plainFont(int n)
  {
    return getFont(plainFont, n, plainSize);
  }
  ...
  {
    return getFont(introFont, n, introSize);
  }

  @Override
  public Font logoFont(int n)
  {
    return getFont(logoFont, n, logoSize);
  }
  ...
  private void loadFontLine(String input, String fontDir, String langCode)
  {
    ...
    InputStream is = inputStream(fontDir + filename);
    if (is == null)
    {
