...
public final class TechCategory implements Base, Serializable
{
  ...
  {
    "TECH_RESEARCH_COMPUTER", "TECH_RESEARCH_CONSTRUCTION",
  ...
  public static String id(int i)
  {
    ...
    {
      case COMPUTER:
        return "TECH_COMPUTERS";
      case CONSTRUCTION:
        return "TECH_CONSTRUCTION";
      case FORCE_FIELD:
        return "TECH_FORCE_FIELDS";
      case PLANETOLOGY:
        return "TECH_PLANETOLOGY";
      case PROPULSION:
        return "TECH_PROPULSION";
      case WEAPON:
        return "TECH_WEAPONS";
    }
    return "";
  ...
  private transient final List<String> knownTechs = new ArrayList<>();
  // possible techs are what remains of the normal research tree
  private transient final List<String> possibleTechs = new ArrayList<>();
...
// location on the research tree. Typically granted by artifact planets.
  private transient final List<String> bonusTechs = new ArrayList<>();
  ...
  {
    return researchCompleted || locked;
  }
  ...
  public boolean isWeaponTechCategory()
  {
    return (this == tree.weapon());
  }

  private float racialMod()
  {
    return tree == null ? 1.0f : tree.empire().techMod(index);
  }

  public float discoveryPct()
  {
    return discoveryPct;
  }
  ...
  public boolean researchStarted()
  {
  ...
  {
    allocation = bounds(0, i, MAX_ALLOCATION_TICKS);
  }

  public float allocationPct()
  {
    return (float) allocation / MAX_ALLOCATION_TICKS;
  }

  public void adjustAllocation(int i)
  {
  ...
  public void decreaseAllocation()
  {
    allocation(allocation - 1);
  }
  ...
  public float baseResearchCost(int techLevel)
  {
    return options().researchCostBase(techLevel) * session().researchMapSizeAdjustment();
  }
  ...
  private void addBonusTech(String id)
  {
    bonusTechs.add(id);
  }
  ...
  public void spyKnownTechs(TechCategory cat)
  {
    spyKnownTechs(cat, 99);
  }
  ...
  public List<String> allTechs()
  {
    return TechLibrary.baseCategory[index].possibleTechs();
  }
  ...
  public String techDescription1(boolean key)
  {
    ...
    {
      case 0:
        return key ? text("TECH_FACTORY_CONTROLS") : text("TECH_FACTORY_CONTROLS_BONUS", tree.empire().maxRobotControls());
      case 1:
        if (key)
        {
  ...
  public String techDescription2(boolean key)
  {
    switch (index)
    {
      ...
      case 3:
        return key ? text("TECH_WASTE_CLEANUP") : text("TECH_WASTE_CLEANUP_BONUS", (int) tree.wasteElimination());
      case 4:
        return key ? text("TECH_SHIP_SPEED") : text("TECH_SHIP_SPEED_AMT", (int) tree.topSpeed());
      case 5:
        return "";
    }
    return "";
