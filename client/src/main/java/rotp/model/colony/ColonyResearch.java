...
public class ColonyResearch extends ColonySpendingCategory
{
  ...
  private transient ColonyResearchProject project;
  private transient ColonyResearchProject completedProject;

  public ColonyResearchProject project()
  {
    return project;
  }
  ...
  public void project(ColonyResearchProject p)
  {
    project = p;
  }
  ...
  public boolean hasCompletedProject()
  {
    return completedProject != null;
  }

  public ColonyResearchProject completedProject()
  {
  ...
  {
    return totalSpending() * researchBonus();
  }

  @Override
  public float totalBCForEmpire()
  {
    return max(0, totalBC() - projectRemainingBC());
  }

  public float totalSpending()
  {
    return super.totalBC();
  }

  public float projectRemainingBC()
  {
    return project == null ? 0 : project.remainingResearchBC();
  }
  ...
  {
    return planet().researchAdj() * empire().researchBonusPct() * session().researchBonus();
  }
