...
public final class SpyNetwork implements Base, Serializable
{
  ...
  {
    mission = Mission.HIDE;
  }

  public void beginSabotage()
  {
    mission = Mission.SABOTAGE;
  }

  public void beginEspionage()
  {
    mission = Mission.ESPIONAGE;
  }

  public boolean isHide()
  {
    return mission == Mission.HIDE;
  }

  public boolean isSabotage()
  {
    return mission == Mission.SABOTAGE;
  }

  public boolean isEspionage()
  {
    return mission == Mission.ESPIONAGE;
  }
  ...
  public void heedEviction()
  {
    threatened = THREAT_EVICT;
  }

  public void heedThreat()
  {
    threatened = THREAT_HIDE;
  }

  public void ignoreThreat()
  {
    threatened = THREAT_NONE;
  }

  public boolean threatened()
  {
    return threatened != THREAT_NONE;
  }

  public boolean evicted()
  {
    return threatened == THREAT_EVICT;
  }
  ...
  public String missionName()
  {
    ...
    {
      case HIDE:
        return text("SPY_HIDE");
      case ESPIONAGE:
        return text("SPY_ESPIONAGE");
      case SABOTAGE:
        return text("SPY_SABOTAGE");
    }
    return "?";
  }
  ...
  {
    return !activeSpies.isEmpty();
  }

  public List<Spy> activeSpies()
  {
    return activeSpies;
  }

  public int numActiveSpies()
  {
    return activeSpies().size();
  }
  ...
  {
    return (float) allocation / MAX_SPENDING_TICKS;
  }
  ...
  public void decreaseSpending()
  {
    allocation(allocation - 1);
  }

  public void increaseSpending()
  {
    allocation(allocation + 1);
  }
  ...
  private void addNewSpy()
  {
    activeSpies.add(new Spy(this));
  }
  ...
  private void startSabotageMission()
  {
    ...
    {
      case FACTORIES:
        eMission.destroyFactories(chosenSystem);
        break;
      case MISSILES:
        eMission.destroyMissileBases(chosenSystem);
        break;
      case REBELS:
        eMission.inciteRebellion(chosenSystem);
        break;
    }
  }
  ...
  public class FleetView implements Serializable
  {
    ...
    public int reportAge()
    {
      return galaxy().currentYear() - date;
    }
  }
}
