...
public class Race implements Base, Serializable
{
  ...
  public transient RaceCombatAnimation troopNormal = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopHostile = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath1 = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath2 = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath3 = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath4 = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath1H = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath2H = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath3H = new RaceCombatAnimation();
  public transient RaceCombatAnimation troopDeath4H = new RaceCombatAnimation();
  public transient List<String> fortressKeys = new ArrayList<>();
  ...
  public transient ImageTransformer diplomacyTransformer;
  public transient List<String> raceNames = new ArrayList<>();
  public transient List<String> homeSystemNames = new ArrayList<>();
  public transient List<String> leaderNames = new ArrayList<>();
  private transient  final List<String> soundKeys = new ArrayList<>();
  public transient List<String> systemNames = new ArrayList<>();

  public transient List<String> shipNamesSmall = new ArrayList<>();
  public transient List<String> shipNamesMedium = new ArrayList<>();
  public transient List<String> shipNamesLarge = new ArrayList<>();
  public transient List<String> shipNamesHuge = new ArrayList<>();

  private transient final List<String> remainingRaceNames = new ArrayList<>();
  private transient final List<String> remainingHomeworldNames = new ArrayList<>();
  private transient final List<String> remainingLeaderNames = new ArrayList<>();
  ...
  public float[] techMod = new float[]
  {
    1, 1, 1, 1, 1, 1
  };
  ...
  public int colonistDelay()
  {
    return colonistDelay;
  }

  public int colonistStartX()
  {
    return colonistX1;
  }

  public int colonistStartY()
  {
    return colonistY1;
  }

  public int colonistStopX()
  {
    return colonistX2;
  }

  public int colonistStopY()
  {
    return colonistY2;
  }

  public int dialogLeftMargin()
  {
    return dialogLeftMargin;
  }

  public int dialogRightMargin()
  {
    return dialogRightMargin;
  }

  public int dialogTopY()
  {
    return dialogTopY;
  }
  ...
  public String nameVariant(int i)
  {
    return raceNames.get(i);
  }
  ...
  public LabelManager raceLabels()
  {
    return labels;
  }
  ...
  public int shipAttackBonus()
  {
    return shipAttackBonus;
  }

  public void shipAttackBonus(int i)
  {
    shipAttackBonus = i;
  }

  public int shipDefenseBonus()
  {
    return shipDefenseBonus;
  }

  public void shipDefenseBonus(int i)
  {
    shipDefenseBonus = i;
  }

  public int shipInitiativeBonus()
  {
    return shipInitiativeBonus;
  }

  public void shipInitiativeBonus(int i)
  {
    shipInitiativeBonus = i;
  }

  public int groundAttackBonus()
  {
    return groundAttackBonus;
  }

  public void groundAttackBonus(int i)
  {
    groundAttackBonus = i;
  }

  public float spyCostMod()
  {
    return spyCostMod;
  }

  public float internalSecurityAdj()
  {
    return internalSecurityAdj;
  }

  public float spyInfiltrationAdj()
  {
    return spyInfiltrationAdj;
  }

  public float workerProductivityMod()
  {
    return workerProductivityMod;
  }

  public int robotControlsAdj()
  {
    return robotControlsAdj;
  }

  public float techDiscoveryPct()
  {
    return techDiscoveryPct;
  }

  public float researchBonusPct()
  {
    return researchBonusPct;
  }

  public float growthRateMod()
  {
    return growthRateMod;
  }

  public float tradePctBonus()
  {
    return tradePctBonus;
  }

  public float positiveDPMod()
  {
    return positiveDPMod;
  }
  ...
  public float councilBonus()
  {
    return councilBonus;
  }

  public boolean ignoresPlanetEnvironment()
  {
    return ignoresPlanetEnvironment;
  }

  public boolean ignoresFactoryRefit()
  {
    return ignoresFactoryRefit;
  }

  public int homeworldKey()
  {
    return homeworldKey;
  }

  public void homeworldKey(int i)
  {
    homeworldKey = i;
  }
  ...
  public void fullTitle(String s)
  {
    fullTitle = s;
  }

  public float defaultRaceRelations()
  {
    return defaultRaceRelations;
  }

  public void defaultRaceRelations(int d)
  {
    defaultRaceRelations = d;
  }
  ...
  public void baseRelations(String key, int d)
  {
    raceRelations.put(key, d);
  }

  public float labFlagX()
  {
    return labFlagX;
  }

  public void labFlagX(float d)
  {
    labFlagX = d;
  }

  public int spyFactoryFrames()
  {
    return spyFactoryFrames;
  }

  public void spyFactoryFrames(int d)
  {
    spyFactoryFrames = d;
  }

  public int spyMissileFrames()
  {
    return spyMissileFrames;
  }

  public void spyMissileFrames(int d)
  {
    spyMissileFrames = d;
  }

  public int spyRebellionFrames()
  {
    return spyRebellionFrames;
  }

  public void spyRebellionFrames(int d)
  {
    spyRebellionFrames = d;
  }
  ...
  public Image flagWar()
  {
    return image(flagWarKey);
  }

  public Image flagNorm()
  {
    return image(flagNormKey);
  }

  public Image flagPact()
  {
    return image(flagPactKey);
  }

  public Image dialogWar()
  {
    return image(dlgWarKey);
  }

  public Image dialogNorm()
  {
    return image(dlgNormKey);
  }

  public Image dialogPact()
  {
    return image(dlgPactKey);
  }

  public Image council()
  {
    return image(councilKey);
  }

  public Image gnnEvent(String id)
  {
    return image(gnnEventKey(id));
  }

  private String gnnEventKey(String id)
  {
    return concat(gnnColor, "_", id);
  }

  public BufferedImage gnn()
  {
    return currentFrame(gnnKey);
  }

  public BufferedImage gnnHost()
  {
    return currentFrame(gnnHostKey);
  }

  public BufferedImage laboratory()
  {
    return currentFrame(laboratoryKey);
  }

  public BufferedImage embassy()
  {
    return currentFrame(embassyKey);
  }

  public BufferedImage holograph()
  {
    return currentFrame(holographKey);
  }

  public BufferedImage mugshot()
  {
    return currentFrame(mugshotKey);
  }

  public BufferedImage setupImage()
  {
    return currentFrame(setupImageKey);
  }

  public BufferedImage spyMugshotQuiet()
  {
    return currentFrame(spyFaceKey, notTalking);
  }

  public BufferedImage soldierMugshot()
  {
    return currentFrame(soldierFaceKey, notTalking);
  }

  public BufferedImage advisorMugshot()
  {
    return currentFrame(advisorFaceKey, notTalking);
  }

  public BufferedImage advisorScout()
  {
    return currentFrame(advisorScoutKey, notTalking);
  }

  public BufferedImage advisorTransport()
  {
    return currentFrame(advisorTransportKey, notTalking);
  }

  public BufferedImage advisorDiplomacy()
  {
    return currentFrame(advisorDiplomacyKey, notTalking);
  }

  public BufferedImage advisorShip()
  {
    return currentFrame(advisorShipKey, notTalking);
  }

  public BufferedImage advisorRally()
  {
    return currentFrame(advisorRallyKey, notTalking);
  }

  public BufferedImage advisorMissile()
  {
    return currentFrame(advisorMissileKey, notTalking);
  }

  public BufferedImage advisorWeapon()
  {
    return currentFrame(advisorWeaponKey, notTalking);
  }

  public BufferedImage advisorCouncil()
  {
    return currentFrame(advisorCouncilKey, notTalking);
  }

  public BufferedImage advisorRebellion()
  {
    return currentFrame(advisorRebellionKey, notTalking);
  }

  public BufferedImage advisorResistCouncil()
  {
    return currentFrame(advisorResistCouncilKey, notTalking);
  }

  public BufferedImage advisorCouncilResisted()
  {
    return currentFrame(advisorCouncilResistedKey, notTalking);
  }

  public BufferedImage diplomatTalking()
  {
    return currentFrame(diplomatKey);
  }

  public BufferedImage scientistTalking()
  {
    return currentFrame(scientistKey);
  }

  public BufferedImage soldierTalking()
  {
    return currentFrame(soldierKey);
  }

  public BufferedImage spyTalking()
  {
    return currentFrame(spyKey);
  }

  public BufferedImage diploMugshotQuiet()
  {
    return currentFrame(mugshotKey, notTalking);
  }

  public BufferedImage diploWideMugshot()
  {
    return currentFrame(wideMugshotKey, notTalking);
  }

  public BufferedImage diplomatQuiet()
  {
    return currentFrame(diplomatKey, notTalking);
  }

  public BufferedImage scientistQuiet()
  {
    return currentFrame(scientistKey, notTalking);
  }

  public BufferedImage soldierQuiet()
  {
    return currentFrame(soldierKey, notTalking);
  }

  public BufferedImage spyQuiet()
  {
    return currentFrame(spyKey, notTalking);
  }

  public BufferedImage councilLeader()
  {
    return asBufferedImage(image(leaderKey));
  }
  ...
  public BufferedImage transportOpening()
  {
    return currentFrame(transportDescKey, open);
  }
  ...
  public BufferedImage fortress(int i)
  {
    return currentFrame(fortressKeys.get(i));
  }

  public int randomFortress()
  {
    return roll(1, fortressKeys.size()) - 1;
  }

  public BufferedImage shield()
  {
    return currentFrame(shieldKey);
  }

  public void resetMugshot()
  {
    resetAnimation(mugshotKey);
  }

  public void resetSetupImage()
  {
    resetAnimation(setupImageKey);
  }

  public void resetDiplomat()
  {
    resetAnimation(diplomatKey);
  }

  public void resetScientist()
  {
    resetAnimation(scientistKey);
  }

  public void resetSoldier()
  {
    resetAnimation(soldierKey);
  }

  public void resetSpy()
  {
    resetAnimation(spyKey);
  }
  ...
  public List<String> shipNames(int size)
  {
    switch (size)
    {
      case ShipDesign.SMALL:
        return shipNamesSmall;
      case ShipDesign.MEDIUM:
        return shipNamesMedium;
      case ShipDesign.LARGE:
        return shipNamesLarge;
      case ShipDesign.HUGE:
        return shipNamesHuge;
    }
    return null;
  }

  public void addSoundKey(String s)
  {
    soundKeys.add(s);
  }
