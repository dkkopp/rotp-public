...
public final class SaveGameUI extends BasePanel implements MouseListener, MouseWheelListener
{
  ...
  private void sortListing()
  {
    ...
    {
      case SORT_FN_UP:
        Arrays.sort(filesList, FILE_NAME);
        break;
      case SORT_FN_DN:
        Arrays.sort(filesList, Collections.reverseOrder(FILE_NAME));
        break;
      case SORT_DT_UP:
        Arrays.sort(filesList, FILE_DATE);
        break;
      case SORT_DT_DN:
        Arrays.sort(filesList, Collections.reverseOrder(FILE_DATE));
        break;
      case SORT_SZ_UP:
        Arrays.sort(filesList, FILE_SIZE);
        break;
      case SORT_SZ_DN:
        Arrays.sort(filesList, Collections.reverseOrder(FILE_SIZE));
        break;
    }
  ...
  private void initGradients()
  {
    ...
    Color[] brownColors =
    {
      brownEdgeC, brownMidC, brownEdgeC
    };
  ...
  private void sortByFileName()
  {
    ...
    {
      case SORT_FN_UP:
        sortOrder = SORT_FN_DN;
        break;
      default:
        sortOrder = SORT_FN_UP;
        break;
    }
    sortListing();
    repaint();
  ...
  private void sortByDate()
  {
    ...
    {
      case SORT_DT_UP:
        sortOrder = SORT_DT_DN;
        break;
      default:
        sortOrder = SORT_DT_UP;
        break;
    }
    sortListing();
    repaint();
  ...
  private void sortBySize()
  {
    ...
    {
      case SORT_SZ_UP:
        sortOrder = SORT_SZ_DN;
        break;
      default:
        sortOrder = SORT_SZ_UP;
        break;
    }
    sortListing();
    repaint();
