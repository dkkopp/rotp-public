...
public class MapOverlayMemoryLow extends MapOverlay
{
  ...
  @Override
  public boolean masksMouseOver(int x, int y)
  {
    return true;
  }
...
class RestartButtonSprite extends MapSprite
{
  ...
  {
    return text("MAIN_MEMORY_LOW_RESTART");
  }
  ...
  public void draw(GalaxyMapPanel map, Graphics2D g)
  {
    if (background == null)
    {
      ...
      Color[] colors =
      {
        parent.edgeC, parent.midC, parent.edgeC
      };
...
class SkipButtonSprite extends MapSprite
{
  ...
  private String label()
  {
    return text("MAIN_MEMORY_LOW_SKIP");
  }
