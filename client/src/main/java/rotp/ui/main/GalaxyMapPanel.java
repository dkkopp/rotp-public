...
public class GalaxyMapPanel extends BasePanel implements ActionListener, MouseListener, MouseWheelListener, MouseMotionListener
{
  ...
  public void toggleSystemNameDisplay(boolean reverse)
  {
    if (reverse)
    {
      ...
      {
        case HIDE_SYSTEM_NAME:
          systemNameDisplay = SHOW_SYSTEM_DATA;
          break;
        case SHOW_SYSTEM_NAME:
          systemNameDisplay = HIDE_SYSTEM_NAME;
          break;
        case SHOW_SYSTEM_DATA:
          systemNameDisplay = SHOW_SYSTEM_NAME;
          break;
      }
    }
    else
  ...
  public void toggleFlightPathDisplay(boolean reverse)
  {
    if (reverse)
    {
      ...
      {
        case SHOW_ALL_FLIGHTPATHS:
          flightPathDisplay = SHOW_NO_FLIGHTPATHS;
          break;
        case SHOW_IMPORTANT_FLIGHTPATHS:
          flightPathDisplay = SHOW_ALL_FLIGHTPATHS;
          break;
        case SHOW_NO_FLIGHTPATHS:
          flightPathDisplay = SHOW_IMPORTANT_FLIGHTPATHS;
          break;
      }
    }
    else
  ...
  public void toggleShipDisplay(boolean reverse)
  {
    if (reverse)
    {
      ...
      {
        case SHOW_ALL_SHIPS:
          shipDisplay = SHOW_ONLY_ARMED_SHIPS;
          break;
        case SHOW_NO_UNARMED_SHIPS:
          shipDisplay = SHOW_ALL_SHIPS;
          break;
        case SHOW_ONLY_ARMED_SHIPS:
          shipDisplay = SHOW_NO_UNARMED_SHIPS;
          break;
      }
    }
    else
  ...
  public void toggleShipRangesDisplay(boolean reverse)
  {
    if (reverse)
    {
      ...
      {
        case SHOW_RANGES:
          showShipRanges = SHOW_NO_STARS_AND_RANGES;
          break;
        case SHOW_STARS_AND_RANGES:
          showShipRanges = SHOW_RANGES;
          break;
        case SHOW_STARS:
          showShipRanges = SHOW_STARS_AND_RANGES;
          break;
        case SHOW_NO_STARS_AND_RANGES:
          showShipRanges = SHOW_STARS;
          break;
      }
    }
    else
  ...
  public void toggleGridCircularDisplay()
  {
    showGridCircular = !showGridCircular;
  }

  public boolean showGridCircular()
  {
    return showGridCircular;
  }

  public boolean showFleetsOnly()
  {
    return flightPathDisplay == SHOW_NO_FLIGHTPATHS;
  }

  public boolean showImportantFlightPaths()
  {
    return flightPathDisplay != SHOW_NO_FLIGHTPATHS;
  }

  public boolean showAllFlightPaths()
  {
    return flightPathDisplay == SHOW_ALL_FLIGHTPATHS;
  }

  public boolean showFriendlyTransports()
  {
    return shipDisplay != SHOW_ONLY_ARMED_SHIPS;
  }

  public boolean showUnarmedShips()
  {
    return shipDisplay == SHOW_ALL_SHIPS;
  }

  public boolean showArmedShips()
  {
    return true;
  }

  public boolean hideSystemNames()
  {
    return systemNameDisplay == HIDE_SYSTEM_NAME;
  }

  public boolean showSystemNames()
  {
    return systemNameDisplay == SHOW_SYSTEM_NAME;
  }

  public boolean showSystemData()
  {
    return systemNameDisplay == SHOW_SYSTEM_DATA;
  }

  public boolean showShipRanges()
  {
    return (showShipRanges == SHOW_RANGES) || (showShipRanges == SHOW_STARS_AND_RANGES);
  }

  public boolean showStars()
  {
    return (showShipRanges == SHOW_STARS) || (showShipRanges == SHOW_STARS_AND_RANGES);
  }
  ...
  public Location currentFocus()
  {
    return parent.mapFocus();
  }

  public void currentFocus(IMappedObject o)
  {
    parent.mapFocus(o);
  }
  ...
  {
    return center.x() - (scaleX * 2 / 5);
  }

  public float mapMinY()
  {
    return center.y() - (scaleY * 2 / 5);
  }

  public float mapMaxX()
  {
    return center.x() + (scaleX * 3 / 5);
  }

  public float mapMaxY()
  {
    return center.y() + (scaleY * 3 / 5);
  }
  ...
  public void sizeX(float s)
  {
    sizeX = s;
  }

  public void sizeY(float s)
  {
    sizeY = s;
  }
      ...
      if ((emp != null) && parent.showOwnership(sys))
      {
        ...
        switch (shape)
        {
          case Empire.SHAPE_SQUARE:
            g.fillRect(x - r1, y - r1, r1 + r1, r1 + r1);
            break;
