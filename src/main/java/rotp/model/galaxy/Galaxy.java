...
public class Galaxy implements Base, Serializable
{
  ...
  {
    return player().race().startingYear;
  }
  ...
  public GalacticCouncil council()
  {
    return council;
  }
  ...
  public int maxNumStarSystems()
  {
    return starSystems.length;
  }
  ...
  public List<StarSystem> abandonedSystems()
  {
    return abandonedSystems;
  }
  ...
  public StarSystem system(int i)
  {
    return (i < 0) || (i >= numStarSystems()) ? null : starSystems[i];
  }
  ...
  public float maxScaleAdj()
  {
    return maxScaleAdj;
  }

  public void player(Empire d)
  {
    playerEmpire = d;
  }
  ...
  @Override
  public boolean isPlayer(Empire d)
  {
    return playerEmpire == d;
  }

  public void initNebulas(int size)
  {
    nebulas = new ArrayList<>(size);
  }
  ...
  public void removeTransport(Transport sh)
  {
    transports.remove(sh);
  }

  public void addTransport(Transport sh)
  {
    transports.add(sh);
  }
