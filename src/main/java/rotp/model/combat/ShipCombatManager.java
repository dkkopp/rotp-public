...
public class ShipCombatManager implements Base
{
  ...
  private final int[] startingPosn =
  {
    30, 40, 20, 50, 10, 60, 0
  };
  private final double[][] riskMap = new double[MAX_X + 1][MAX_Y + 1];
  public boolean[][] asteroidMap = new boolean[MAX_X + 1][MAX_Y + 1];
  private boolean initialPause;
  public List<CombatStack> currentTurnList;

  public boolean interdiction()
  {
    return interdiction;
  }

  public ShipCombatResults results()
  {
    return results;
  }
  ...
  public CombatStack currentStack()
  {
    return currentStack;
  }

  public List<CombatStack> activeStacks()
  {
    return results.activeStacks();
  }

  public void ui(ShipBattleUI panel)
  {
    ui = panel;
  }
  ...
  {
    return showAnimations && (ui != null) && playerInBattle;
  }

  public List<CombatStack> allStacks()
  {
    return allStacks;
  }

  public void setInitialPause()
  {
    initialPause = true;
  }
