...
public final class TechMissileShield extends Tech
{
  ...
  @Override
  public boolean canBeMiniaturized()
  {
    return true;
  }
  ...
  @Override
  public float warModeFactor()
  {
    return 1.5f;
  }

  @Override
  public boolean providesShipComponent()
  {
    return true;
  }
  ...
  {
    return switch (typeSeq)
    {
      case 0 -> 10;

      case 1 ->  switch (d.size())
      {
        case ShipDesign.SMALL -> 5;

        case ShipDesign.MEDIUM -> 10;

        case ShipDesign.LARGE -> 20;

        case ShipDesign.HUGE -> 30;
        default -> 0;
      };

      case 2 -> switch (d.size())
      {
        case ShipDesign.SMALL -> 20;

        case ShipDesign.MEDIUM -> 30;

        case ShipDesign.LARGE -> 40;

        case ShipDesign.HUGE -> 50;
        default -> 0;
      };
